  ...
  return (
    <div className="space-y-6">
      <section className="grid gap-4 xl:grid-cols-[1.3fr_0.7fr]">
        <div className="rounded-3xl bg-primary p-6 text-primary-foreground sm:p-8">
          <div className="flex items-start justify-between">
            ...
            <CircleDollarSign className="h-6 w-6 opacity-60" />
          </div>
          ...
          <div className="mt-3 h-2 rounded-full bg-white/20">
            <div
              ...
              style={{ width: `${budget ? Math.min(100, Math.round((spent / budget) * 100)) : 0}%` }}
            />
          </div>
        </div>
        <button
          onClick={onShopping}
          className="group rounded-3xl border border-border bg-card p-6 text-left transition hover:-translate-y-0.5 hover:shadow-lg sm:p-8"
        >
          <div className="flex items-center justify-between">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#d7f36b] text-[#27320d]">
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_1fr]">
        <div className="rounded-3xl border border-border bg-card p-6 sm:p-7">
          <div className="flex items-center justify-between">
            ...
            <button className="text-xs font-medium text-primary">Podrobnosti</button>
          </div>
        ...
        <div className="rounded-3xl bg-[#d7f36b] p-6 text-[#27320d] sm:p-7">
          <div className="flex items-start justify-between">
            <div>
              <div className="flex items-center gap-2 text-sm font-semibold">
                <Sparkles className="h-4 w-4" /> Tip od AI
              </div>
            ...
            <button onClick={onShopping} className="rounded-full bg-[#27320d] p-2 text-[#d7f36b]" aria-label="Zobrazit doporučení">
              <ArrowUpRight className="h-4 w-4" />
            </button>
          </div>
          <button onClick={onShopping} className="mt-8 text-sm font-semibold underline underline-offset-4">
            Zobrazit nabídku
          </button>
        </div>
      </section>
      <section className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-border bg-card px-5 py-4">
        ...
        <button onClick={onExpense} className="rounded-xl bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
          + Nový výdaj
        </button>
      </section>
    </div>
